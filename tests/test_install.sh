...
test_installs_claude_layout() {
    ...
    mkdir -p "$default_onespace"
    printf 'legacy\n' > "$default_onespace/codex-plan.sh"
    printf 'legacy\n' > "$default_onespace/plan-template.md"
    mkdir -p "$default_runtime/scripts"
    printf 'legacy\n' > "$default_runtime/scripts/codex-plan.sh"
    printf 'legacy\n' > "$default_runtime/scripts/codex-review.sh"
    printf 'legacy\n' > "$default_runtime/scripts/opencode-review.sh"
    ...
    assert_file_not_exists "$default_onespace/codex-plan.sh"
    assert_file_not_exists "$default_onespace/plan-template.md"
    ...
    assert_file_not_exists "$default_runtime/scripts/codex-plan.sh"
    assert_file_not_exists "$default_runtime/scripts/codex-review.sh"
    assert_file_not_exists "$default_runtime/scripts/opencode-review.sh"
...
test_syncs_custom_onespace_and_runtime_directories() {
    ...
    mkdir -p "$onespace"
    printf 'legacy\n' > "$onespace/codex-review.sh"
    printf 'legacy\n' > "$onespace/review-template.md"
    mkdir -p "$runtime_home/scripts"
    printf 'legacy\n' > "$runtime_home/scripts/codex-plan.sh"
    printf 'legacy\n' > "$runtime_home/scripts/codex-review.sh"
    printf 'legacy\n' > "$runtime_home/scripts/opencode-review.sh"
    ...
    assert_file_not_exists "$runtime_home/scripts/codex-plan.sh"
    assert_file_not_exists "$runtime_home/scripts/codex-review.sh"
    assert_file_not_exists "$runtime_home/scripts/opencode-review.sh"
    assert_file_not_exists "$onespace/flow-change.sh"
    assert_file_not_exists "$onespace/codex-review.sh"
