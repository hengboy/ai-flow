...
test_custom_roots_install() {
    ...
    assert_contains "$opencode_agents/ai-flow-opencode-plan/AGENT.md" "color: purple"
    assert_contains "$opencode_agents/ai-flow-opencode-plan/AGENT.md" "tools: Bash"
    ...
    assert_contains "$opencode_agents/ai-flow-opencode-plan-review/AGENT.md" "tools: Bash"
    ...
    assert_contains "$opencode_agents/ai-flow-opencode-plan-coding-review/AGENT.md" "tools: Bash"
