...
test_regular_passed_with_notes_to_done() {
    ...
    assert_equals ".ai-flow/reports/20260503-demo-review.md" "$(state_field "$project" "20260503-demo" "transitions.4.payload.report_file")"
    assert_equals "Codex" "$(state_field "$project" "20260503-demo" "transitions.4.payload.engine")"
    assert_equals "gpt-5.4" "$(state_field "$project" "20260503-demo" "transitions.4.payload.model")"
